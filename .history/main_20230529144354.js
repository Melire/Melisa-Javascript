    ...
    switch (eleccionUsuario) {
        case "TIJERA": {
            if (eleccionUsuario == eleccionMaquina) {
                ...
                document.getElementById('resultanteEmpatas').innerHTML = "Empataste! la maquina eligió: " + eleccionMaquina;
            }
            else if (eleccionMaquina == "PIEDRA") {
                document.getElementById('resultante').innerHTML = "Perdiste! la maquina eligió: " + eleccionMaquina;
            }
            else {
                document.getElementById('resultante').innerHTML = "Ganaste! la maquina eligió: " + eleccionMaquina;
            }
        }
            break;
        ...
        case "PIEDRA":
            if (eleccionUsuario == eleccionMaquina) {
                ...
                ddocument.getElementById('resultante').innerHTML="Ganaste! la maquina eligió: " + eleccionMaquina;
            }
            break;
